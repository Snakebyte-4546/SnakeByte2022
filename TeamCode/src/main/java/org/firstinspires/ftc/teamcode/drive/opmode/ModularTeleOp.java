...
//  VECTOR PARAMS
    ...
    public  boolean precisionVector;
...
//  HEADING PARAMS
    ...
    public boolean precisionHeading;
...
//  HEADING METHODS
    ...
    private boolean headingCheck_RStick(MecanumDrive drive) {
        if (gamepad1.right_stick_x > .1 || gamepad1.right_stick_x < -.1 || gamepad1.right_stick_y > .1 || gamepad1.right_stick_y < -.1) {
    ...
    private void precisionToggleCheck() {
        if (gamepad1.left_stick_button && (runtime.time() - timeAtLastPHChange) > 400) {
